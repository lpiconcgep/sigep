...
$sql = "SELECT 
            ...
            e.fecha_ingreso, e.fecha_retiro,e.motivo_retiro_id,e.fecha_grado,
            e.created_at as fecha_registro, e.condicion_estudiante_id,
...
if(isset($option_report) && $option_report == 'retiros' )
    ...
    $sql .= " ORDER BY pr.nombre ASC, p.primer_apellido ASC, p.primer_nombre ASC";
